...
class s5DecaySolver:
    ...
    def _define_matrix_equation(self):
        ...
        A = sp.Matrix([
            [0, k['k_fls1s0'] + k['k_ics1s0'], k['k_fls2s0'], k['k_pht1s0'] + k['k_isct1s0'], 0],
            [0, -(k['k_fls1s0'] + k['k_ics1s0'] + k['k_iscs1t1'] + k['k_iscs1t2'] + k['k_ics1s2']), k['k_ics2s1'], k['k_risct1s1'], k['k_risct2s1']],
            [0, k['k_ics1s2'], -(k['k_fls2s0'] + k['k_ics2s1'] + k['k_iscs2t1'] + k['k_iscs2t2']), k['k_risct1s2'], k['k_risct2s2']],
            [0, k['k_iscs1t1'], k['k_iscs2t1'], -(k['k_pht1s0'] + k['k_isct1s0'] + k['k_risct1s1'] + k['k_risct1s2'] + k['k_ict1t2']), k['k_ict2t1']],
            [0, k['k_iscs1t2'], k['k_iscs2t2'], k['k_ict1t2'], -(k['k_risct2s1'] + k['k_ict2t1'] + k['k_risct2s2'])]
        ])
