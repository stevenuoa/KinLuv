...
def main(
    ...
    k_risct1s1, k_risct1s2, k_risct2s1, k_risct2s2, k_fls1s0, k_fls2s0, k_ics2s0,
    k_ics1s0, k_ics2s1, k_rics1s2, k_ict2t1, k_rict1t2, k_pht1s0, k_isct2s0, k_pht2s0, time_pulse, num_photon, time_excitation, time_decay
):
    rate_constants = {
        'k_abss0s2': k_abss0s2,
        'k_iscs1t1': k_iscs1t1,
